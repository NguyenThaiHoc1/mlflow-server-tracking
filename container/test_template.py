...
"""
    https://medium.com/@Sushil_Kumar/setting-up-mlflow-on-google-cloud-for-remote-tracking-of-machine-learning-experiments-b48e0122de04
"""
import os
import warnings
import sys
...
if __name__ == "__main__":
    ...
    with mlflow.start_run(experiment_id=exp_id):
        ...
        if tracking_url_type_store != "file":
            ...
            mlflow.sklearn.log_model(lr, "model", registered_model_name="ElasticnetWineModel_1")
        else:
